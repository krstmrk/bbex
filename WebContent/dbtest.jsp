...
<body>
	...
	<h1>
		<a href="index.html">B B E X</a>
	</h1>
	<nav id="nav">
	<ul>
		<li><a href="index.html">Home</a></li>
		<li><a href="" class="icon fa-angle-down">Services</a>
			<ul>
	...
	<div class="box">
		<h3>What is BBEX?</h3>
		<p>Batangas-Bicol Expressway, commonly known as BBEX, is a
			private-owned freeway which ranges from the city of Batangas to the
			city of Legazpi in the Bicol region. It is the longest expressway in
			the country and is also one of the safest there is.</p>
	</div>
	</section>
